...
# Wrap the main part of the script in braces and pipe its output (stdout and stderr) to tee
{
  ...
  log_step "Resetting main model to default (DeepSeek R1 via OpenRouter) before provider tests"
      task-master models --set-main deepseek/deepseek-r1-0528:free --openrouter
    log_success "Main model reset to deepseek/deepseek-r1-0528:free via OpenRouter."
